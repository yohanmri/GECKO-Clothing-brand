        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center py-8 border-b border-gray-100">
              ...
              <div className="hidden md:block col-span-2 text-center font-audiowide text-lg">$145.00</div>
              ...
              <div className="col-span-1 md:col-span-2 text-left md:text-right font-audiowide text-lg">$145.00</div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center py-8 border-b border-gray-100">
              ...
              <div className="hidden md:block col-span-2 text-center font-audiowide text-lg">$65.00</div>
              <div className="col-span-1 md:col-span-2 flex justify-start md:justify-center">
                <div className="flex items-center border border-gray-200">
                  <button className="px-4 py-2 hover:bg-gray-50">-</button>
              ...
              <div className="col-span-1 md:col-span-2 text-left md:text-right font-audiowide text-lg">$130.00</div>
            </div>
            ...
            <div className="bg-gray-50 p-8 border border-gray-100">
              ...
              <div className="space-y-4 mb-6 text-sm font-medium">
                <div className="flex justify-between">
                  ...
                  <span className="font-audiowide text-black">$275.00</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">Shipping</span>
                  <span className="font-audiowide text-black">Calculated at checkout</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">Tax</span>
                  <span className="font-audiowide text-black">$0.00</span>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-6 mb-8 flex justify-between items-center">
                ...
                <span className="font-audiowide text-2xl text-black">$275.00</span>
              </div>
